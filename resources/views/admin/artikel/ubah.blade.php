...
<head>
	...
	<title>Ubah Artikel - SD Swasta Mutiara Balige</title>
					...
					<div class="card-body">
						<form method="POST" action="" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input type="text" value="" class="form-control" id="judul" placeholder="judul artikel" autocomplete="off" required="required" name="judul">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								*gambar sebelumnya <br>
								<img src="" alt="" width="500px" class="mt-2">
							</div>
							<div class="form-group">
